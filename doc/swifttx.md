...
This mechanism has been integrated into Bitcore-Node-DONATE which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/DONATE-Project/insight-api-donate#web-socket-api](https://github.com/DONATE-Project/insight-api-donate#web-socket-api) 
* API: [https://github.com/DONATE-Project/insight-api-donate#swifttx-transactions](https://github.com/DONATE-Project/insight-api-donate#swifttx-transactions) 
...
By default, the DONATE Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the DONATE Core daemon:
