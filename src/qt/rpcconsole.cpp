                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzDONPathCustom = GetArg("-zdonbackuppath", "");
    ...
    if(!strzDONPathCustom.empty()) {
        ui->wallet_customzdonbackuppath->setText(QString::fromStdString(strzDONPathCustom));
        ui->wallet_customzdonbackuppath_label->setVisible(true);
        ui->wallet_customzdonbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzDONPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the DONATE RPC console.") + "<br>" +
