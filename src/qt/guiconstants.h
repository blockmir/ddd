...
/* Donate GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "DONATE"
#define QAPP_ORG_DOMAIN "donate.org"
#define QAPP_APP_NAME_DEFAULT "DONATE-Qt"
#define QAPP_APP_NAME_TESTNET "DONATE-Qt-testnet"
