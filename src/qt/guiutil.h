...
/** Utility functions used by the DONATE Qt UI.
 */
namespace GUIUtil
{
...
// Render DONATE addresses in monospace font
...
// Parse "donate:" URI into recipient object, return true on successful parsing
