...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* DONATE features */
        {"donate", "masternode", &masternode, true, true, false},
        {"donate", "listmasternodes", &listmasternodes, true, true, false},
        {"donate", "getmasternodecount", &getmasternodecount, true, true, false},
        {"donate", "masternodeconnect", &masternodeconnect, true, true, false},
        {"donate", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"donate", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"donate", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"donate", "masternodecurrent", &masternodecurrent, true, true, false},
        {"donate", "masternodedebug", &masternodedebug, true, true, false},
        {"donate", "startmasternode", &startmasternode, true, true, false},
        {"donate", "createmasternodekey", &createmasternodekey, true, true, false},
        {"donate", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"donate", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"donate", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"donate", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"donate", "getmasternodescores", &getmasternodescores, true, true, false},
        {"donate", "mnbudget", &mnbudget, true, true, false},
        {"donate", "preparebudget", &preparebudget, true, true, false},
        {"donate", "submitbudget", &submitbudget, true, true, false},
        {"donate", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"donate", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"donate", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"donate", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"donate", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"donate", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"donate", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"donate", "checkbudgets", &checkbudgets, true, true, false},
        {"donate", "mnsync", &mnsync, true, true, false},
        {"donate", "spork", &spork, true, true, false},
        {"donate", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        {"zerocoin", "getzdonseed", &getzdonseed, false, false, true},
        {"zerocoin", "setzdonseed", &setzdonseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzdon", &searchdzdon, false, false, true},
        {"zerocoin", "dzdonstate", &dzdonstate, false, false, true}
...
{
    return "> donate-cli " + methodname + " " + args + "\n";
}
