...
#   c) node1 mines 32 blocks, so now node 0 has 60001don, node 1 has 4250don, node2 has none.
#   d) node0 sends 601 don to node2, in two transactions (301 don, then 300 don).
